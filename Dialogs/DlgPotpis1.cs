...
{
    public partial class DlgPotpis1 : Form
    {
        private DataTable tblZaposleni;
        private DataTable tblPotpisi;
        private int idZaposl = 0;

        public DlgPotpis1(DataTable Ime, DataTable potpis)
        {
            InitializeComponent();
        ...
        private void btnDA_Click(object sender, EventArgs e)
        {
            ...
            DlgPlacanje.potpiss = Label1.Text;
            DlgPlacanje.IdImee = idZaposl;
            DlgPlacanje.Korisnik = Label2.Text;
